...
| 15 | `HIL-CONFIG-TRANSACTIONS` | Cursor；Codex 只读验收 | §15.0-6 | active | 用户 20:27 转交 Cursor；按 runbook 执行 C1–C6 并完整回滚 |
