...
| 7 | `WBS-1-UNIFIED-FIRMWARE` | Zcode | 1.1-1.7 | ready / 1.5 slice 2 implementation B3R5 | `2bd169c` 擦除预填与 accept/reject 计数不得回退；I/O 非零不得走 default+invalidate；B4 冻结；不刷机 |
