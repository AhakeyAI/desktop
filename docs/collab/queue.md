...
| 7 | `WBS-1-UNIFIED-FIRMWARE` | Zcode | 1.1-1.7 | ready / 1.5 slice 2 implementation B2R2 | B2R1 退回：T6 仍恒真、meta_read fail-open、栈门禁仅 default、T3 无 wrapper 集成；B3/B4 冻结；不刷机 |
