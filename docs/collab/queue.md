...
| 7 | `WBS-1-UNIFIED-FIRMWARE` | Zcode | 1.1-1.7 | ready / 1.6 checkpoint A | 1.5 implementation accepted @ `b678137`；先冻结 USB/BLE identity 与 VBUS 差异；不刷机 |
...
| 15I-R2 | `V021-RUNTIME-SIGPIPE-SURVIVAL` | Cursor；Codex 验收 | v0.2.1 Runtime 稳定性 | ready / implementation R1 | `9130cd3` no-SIGPIPE 方向成立；补真实 status/permission barrier、listener shutdown、EAGAIN 有界等待与 10 轮稳定门禁 |
