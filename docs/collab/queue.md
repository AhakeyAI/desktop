...
| 7 | `WBS-1-UNIFIED-FIRMWARE` | Zcode | 1.1-1.7 | ready / 1.5 slice 2 implementation B1 | A1–A12 design accepted @ `5386e48`；先做 codec/progress 深 Module + T23/T24/T28 |
...
| 15F2 | `HIL-RELEASE-0.2-INSTALLER-RECOVERY-REWORK` | Cursor；Codex 验收 | 5.9A-R8 / 6.0A | active / R1 | Runtime fail-forward 已 accepted；Cursor 只收口 disabled/nonRestorable/双错误，不再改系统 |
| 15G | `HIL-RELEASE-0.2` | Cursor 执行；Zcode 只读验证 | 6.0A / v0.2 | blocked / 15F2 R1 | 0.2 official Runtime 已恢复且 XPC 通过；安装器仍失败，Studio/BLE smoke 未做 |
