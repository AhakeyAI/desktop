...
| 7 | `WBS-1-UNIFIED-FIRMWARE` | Zcode | 1.1-1.7 | ready / 1.5 slice 2 implementation B1R1 | B1 @ `93a3465` 退最小返工：ABI pin fail-open、progress overflow/重复完成帧、真实 ABI/padding oracle；B2 冻结 |
