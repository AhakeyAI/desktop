...
| 7 | `WBS-1-UNIFIED-FIRMWARE` | Zcode | 1.1-1.7 | ready / 1.5 slice 2 checkpoint A7 | `ef3ba24` 其它项闭环；补齐 1.4 trigger×phase core-owned recovery action matrix，不刷机 |
...
| 15F1 | `HIL-RELEASE-0.2-PACKAGING-REWORK` | Cursor；Codex 验收 | 5.9A-R7 / 6.0A | ready / R2 | `80a95e4` R1 主体通过；修正真实 codesign requirement invocation 并补生产 helper 集成测试 |
