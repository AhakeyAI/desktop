...
| 7 | `WBS-1-UNIFIED-FIRMWARE` | Zcode | 1.1-1.7 | ready / 1.5 slice 2 implementation B1R3 | B1R2 核心修复保留；收口 clean-checkout mutation、两入口证明、真实 self-containment 门禁与完整 legacy ABI；B2 冻结 |
