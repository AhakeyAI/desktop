...
| 15K | `V03-STUDIO-OLED-LEGACY-COMPATIBILITY` | Cursor；Codex 验收 | v0.3 客户端 OLED | ready / C1 | 能力 profile + planner/opcode 路由；正式 UI 兼容 GitHub Standard/Gitee Rhino/Local Rhino，不依赖刷统一固件 |
