...
| 15A | `HIL-CONFIG-0x99-CAPS14` | Cursor | HIL 阻塞返工 | active / R1 | Codex 21:30：补 compact 结构校验与边界容量整体 fail-closed；HIL 继续暂停 |
...
队列不是一般并行许可。调度 OPS、WBS 5.2、`WBS-5.3-C-CURSOR`、`WBS-5.3-ORCHESTRATOR`、`HIL-RUNTIME-1-HOOK-SERVER`、`HIL-RUNTIME-1`、`WBS-5.4-LIFECYCLE`、`WBS-0-RISK-CLOSURE`、`WBS-5.5-DEVICE-OWNER`、`WBS-5.5-HIL-REWORK`、`HIL-RUNTIME-2`、`WBS-5.6-CONFIG-TRANSACTIONS` 与 `WBS-5.7-STUDIO-CLIENT` 已 accepted（5.6 有效基线 `19eb4dc`；5.7 有效基线 `488097d`）。当前 `HIL-CONFIG-0x99-CAPS14` 处于 active / R1；HIL-CONFIG 环境保留并 blocked，固件 WBS-1.4 继续暂停。CAPS14 验收通过后才恢复 C1。刷机、远端 push 和量产切换仍需 USER-GATE。
