...
| 1.6 | **B2A accepted @ `4fb65a8`；B1R11 @ `3971ce2` 退 B1R12**：删除 block10 重复 drop、reset 改真实 opposite transport、两处 comment-aware brace scope、四 mutant 可复现证据及真实固件 H/E/六列表格；实机 7A/7B 与 VBUS 行为切换仍待 USER-GATE | 传输回归报告 | 1.2 |
