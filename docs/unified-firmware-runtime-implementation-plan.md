...
| 1.6 | **B2A accepted @ `4fb65a8`；B1R9 @ `5e23f4c` 退 B1R10**：闭合 busy/split byte-exact、reset 全字段+真实 re-admit、wiring 结构作用域与报告证据列；实机 7A/7B 与 VBUS 行为切换仍待 USER-GATE | 传输回归报告 | 1.2 |
