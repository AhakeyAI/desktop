...
| 1.6 | **B1 accepted/closed @ `278f56e`（H=`35db500`）；B2A 报告定稿**：host/static、双入口、wiring 反向 mutants、lifecycle 与 H/E 均闭合。下一步仅开放 VBUS B2 三项 USER-GATE 裁决准备；生产 VBUS 改动、7A/7B HIL、刷机与 1.7 仍未授权 | 传输回归报告 | 1.2 |
