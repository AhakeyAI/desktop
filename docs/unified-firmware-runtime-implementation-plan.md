...
| 1.6 | **B2A accepted @ `4fb65a8`；B1R10 @ `7be9716` 退 B1R11**：修 block10 调用前快照、reset opposite transport、fixture 清理、brace-precise wiring 与真实固件 H/E/六列表格；实机 7A/7B 与 VBUS 行为切换仍待 USER-GATE | 传输回归报告 | 1.2 |
